...
class RpcClient:
    ...
    async def get_fee_estimate(self, request: Optional[dict] = None) -> dict: ...

    async def get_current_network(self, request: Optional[dict] = None) -> dict: ...

    async def get_system_info(self, request: Optional[dict] = None) -> dict: ...
